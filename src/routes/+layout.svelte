...
<MetaTags
  {title}
  description="Oct icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-oct.vercel.app/',
    title: 'Svelte Oct',
    description: 'Oct icon set for Svelte',
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-oct',
        width: 1200,
        height: 630,
        alt: 'Svelte Oct'
      }
    ],
    site_name: 'Svelte Oct'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Oct',
    description: 'Oct icon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-oct',
    imageAlt: 'Svelte Oct'
  }}
/>
...
<header class="flex-none w-full mx-auto bg-white dark:bg-slate-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-slate-950 ">
    ...
    >
      ...
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-oct">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-slate-950">
  <div class="sm:flex sm:items-center sm:justify-between">
    <FooterBrand
      href="https://svelte-oct.vercel.app/"
      name="Svelte Oct"
    ...
    >
      ...
      <FooterLink class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-oct"
        >GitHub</FooterLink
      >
